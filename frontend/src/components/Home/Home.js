      ...
      <div className='bg-[#121212] h-screen box-border'>
        ...
        <div className="absolute inset-0 w-full h-full bg-[#121212] [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
          ...
          {/* <div className=" p-8 rounded-2xl shadow-lg w-full max-w-md text-center">
            <h1 className="text-3xl text-white font-bold mb-6">Welcome to Our App</h1>
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-gray-300 text-black p-3 rounded-xl hover:bg-gray-400 transition"
              >
                Login
              </button>
            </div>
